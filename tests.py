...
class PartyTests(unittest.TestCase):
    ...
    def test_no_rsvp_yet(self):
        ...
        self.assertIn('I want to come', result.data)
        # print result.data
    ...
    def test_rsvp(self):
        ...
        # not the RSVP form
        self.assertNotIn("I want to come", result.data)
...
class PartyTestsDatabase(unittest.TestCase):
    ...
    def test_games(self):
        ...
        self.assertIn("sparkle pants", result.data)
        self.assertIn("snowflake sunshine", result.data)
